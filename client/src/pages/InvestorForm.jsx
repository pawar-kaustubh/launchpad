  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // Send data to backend
        const response = await fetch("/api/investor/createin", {
          method: "POST",
          headers: {
        ...
        console.log("Investor created:", responseData);
      ...
      fields: [
        {
          ...
          name: "about",
          placeholder:
            "Tell us about your investment philosophy and experience",
        },
        {
          label: "Portfolio Companies",
          type: "textarea",
          name: "portfolio",
          placeholder: "List companies you've invested in (names or URLs)",
        },
      ],
    },
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-100 to-green-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden text-center p-8">
          ...
          <p className="mt-2 text-gray-600">
            Thank you for joining our investor network. We'll match you with
            relevant startup opportunities.
          </p>
          <button
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 py-8 px-4 sm:px-6 lg:px-8 mt-15">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-green-700 py-6 px-6 relative">
          <div
            className="absolute top-0 left-0 h-1 bg-gray-300 transition-all duration-300"
            style={{
              width: `${progress}%`,
              background:
                progress > 0
