        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <a href={`https://${startup.website}`} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">
                  {startup.website}
                </a>
              </div>
              <div>
              ...
              <div>
                ...
                <a href={startup.youtube} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <a href={`mailto:${startup.email}`} className="text-blue-400 hover:underline">{startup.email}</a>
              </div>
              <div>
              ...
              <div>
                ...
                <a href={startup.pitchdeck} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">
                  View Pitch Deck
                </a>
              </div>
            </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className={`p-4 rounded-lg ${startup.revenue > 1000000 ? 'bg-blue-900/30 border border-blue-400/30' : 'bg-gray-700/50'}`}>
                <h3 className="text-gray-400">Annual Revenue</h3>
                <p className="text-2xl font-bold">{formatCurrency(startup.revenue)}</p>
                <p className="text-sm text-gray-400">Total sales</p>
              </div>
              <div className={`p-4 rounded-lg ${getProfitabilityClass(startup.profit).includes('green') ? 'bg-green-900/30 border border-green-400/30' : 'bg-red-900/30 border border-red-400/30'}`}>
              ...
              <div className="p-4 rounded-lg bg-gray-700/50">
                ...
                <p className="text-2xl font-bold">{formatNumber(startup.customers)}</p>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className={`p-4 rounded-lg ${getGrowthClass(startup.growthRate).includes('green') ? 'bg-green-900/30 border border-green-400/30' : getGrowthClass(startup.growthRate).includes('yellow') ? 'bg-yellow-900/30 border border-yellow-400/30' : 'bg-red-900/30 border border-red-400/30'}`}>
              ...
              <div className="p-4 rounded-lg bg-gray-700/50">
                ...
                <p className="text-2xl font-bold text-green-400">{startup.satisfaction}%</p>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className={`p-4 rounded-lg ${startup.burnrate > 200000 ? 'bg-red-900/30 border border-red-400/30' : 'bg-yellow-900/30 border border-yellow-400/30'}`}>
                <h3 className="text-gray-400">Monthly Burn</h3>
                <p className={`text-2xl font-bold ${startup.burnrate > 200000 ? 'text-red-400' : 'text-yellow-400'}`}>
                  {formatCurrency(startup.burnrate)}
                </p>
                <p className="text-sm text-gray-400">Cash expenditure</p>
              </div>
              <div className={`p-4 rounded-lg ${getRunwayClass(startup.runway).includes('green') ? 'bg-green-900/30 border border-green-400/30' : getRunwayClass(startup.runway).includes('yellow') ? 'bg-yellow-900/30 border border-yellow-400/30' : 'bg-red-900/30 border border-red-400/30'}`}>
