...
function FloatingStartupModel() {
  const group = useRef();
  const { nodes, materials } = useGLTF('https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/low-poly-sphere/model.glb');
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white overflow-x-hidden">
        ...
        {[...Array(30)].map((_, i) => (
          <div 
            ...
            style={{
              ...
              transform: `translate(${mousePos.x * 2}px, ${mousePos.y * 2 + scrollY * 0.2}px)`
            }}
          />
        ))}
      </div>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-md py-4 px-8 flex justify-between items-center border-b border-gray-700">
        ...
        <div className="hidden md:flex space-x-8">
          <button 
            className={`px-4 py-2 rounded-full transition-all ${activeTab === 'startups' ? 'bg-blue-600 text-white' : 'hover:text-blue-400'}`}
            onClick={() => setActiveTab('startups')}
          >
            Raise Funds
          </button>
          <button 
            className={`px-4 py-2 rounded-full transition-all ${activeTab === 'investors' ? 'bg-blue-600 text-white' : 'hover:text-blue-400'}`}
      ...
      <section className="relative h-screen flex items-center justify-center pt-16">
        <ErrorBoundary>
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <Canvas camera={{ position: [0, 0, 5], fov: 50 }} className="w-full h-full opacity-20">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Launchpad helps startups and investors grow together through innovative matchmaking
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              ...
              <svg 
                className={`w-5 h-5 ml-2 transition-transform ${isHovering ? 'translate-x-2' : ''}`} 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              The <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Future</span> of Startup Funding
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our platform combines cutting-edge technology with human expertise to create perfect matches
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Our AI finds investors tailored to your startup in seconds"
              },
              {
                icon: (
              ...
              },
              {
                ...
                description: "All investors are thoroughly vetted before joining"
              }
            ].map((item, index) => (
              <div 
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative h-96">
            {testimonials.map((testimonial, index) => (
              <div 
                key={index}
                className={`absolute inset-0 transition-opacity duration-500 ${currentTestimonial === index ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
              >
          ...
          <div className="flex justify-center mt-8 space-x-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all ${currentTestimonial === index ? 'bg-blue-500 w-6' : 'bg-gray-600'}`}
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-blue-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              By The <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Numbers</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">See LaunchPad in Action</h2>
      ...
      <section className="py-32 bg-gradient-to-r from-blue-900/50 to-purple-900/50 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            Ready to <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Launch</span> Your Vision?
          </h2>
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Join thousands of startups and investors already changing the world together
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">The future of startup funding and investment</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">For Startups</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition">Raise Funds</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition">Pitch Deck Tools</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition">Mentorship</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">For Investors</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition">Explore Startups</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition">Deal Flow</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition">Due Diligence</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 mb-4 md:mb-0">© 2023 LaunchPad. All rights reserved.</p>
